...
<form action="index.php" method="post" name="login" class="klogin-form-login" >
	...
	<p class="klogin-form-login-username">
		...
		<input id="klogin-username" class="klogin-username" type="text" name="<?php echo $this->login['field_username']; ?>" class="kinputbox" alt="username" size="18" />
	</p>
	<p class="klogin-form-login-password">
		<label for="klogin-passwd"><?php echo JText::_('MOD_KUNENALOGIN_PASSWORD') ?></label>
		<input id="klogin-passwd" class="klogin-passwd" type="password" name="<?php echo $this->login['field_password']; ?>" class="kinputbox" size="18" alt="password" />
	</p>
